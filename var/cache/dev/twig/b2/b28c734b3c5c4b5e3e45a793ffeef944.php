...
class __TwigTemplate_2874d1704e6ccef851cd257d1e48893c extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        echo "
\t\t<div id=\"form\">
\t\t\t<img class=\"user__profile__picture\" src=\"";
        // line 14
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 14, $this->source); })()), "profilePicture", [], "any", false, false, false, 14)), "html", null, true);
        echo "\" alt=\"profile_picture\">
\t\t\t";
        // line 15
...
\t\t{{ form_start(form) }}
\t\t<div id=\"form\">
\t\t\t<img class=\"user__profile__picture\" src=\"{{ asset(user.profilePicture)}}\" alt=\"profile_picture\">
\t\t\t{{ form_widget(form)}}
\t\t\t<button type=\"submit\" class=\"btn btn-primary\">Submit</button>
\t\t\t<button type=\"reset\" class=\"btn btn-cancel\">Cancel</button>
\t\t\t<br/><br/>
...
\t</section>
{% endblock %}
", "profile/profile.html.twig", "/Users/sebastien/Sebbe's Cloud/School/OpenClassRooms/3 - OCR - Développeur d'application - PHP & Symfony/Projet 6 (120h)/P6 - Mission/0 - Code/templates/profile/profile.html.twig");
    }
}
