...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\CommentFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\MediaFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\TrickFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\UserFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService'))), 'groups' => []]]);
