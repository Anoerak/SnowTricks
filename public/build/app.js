...
if (headTitle.includes('Home')) {
  ...
  var getMoreTricks = function getMoreTricks(lastTrickIndex) {
    var url = 'https://127.0.0.1:8000/load-more-tricks/' + lastTrickIndex + '/' + getTricksCount();
    console.log(url);
    fetch(url).then(function (response) {
